...
output:
  html_vignette:
    ...
    df_print: kable
vignette: >
  %\VignetteIndexEntry{An Introduction to Visibly}
...
```{r colorgorical-show, eval=T, echo=F}
x = c(
  "#002B00",
  "#95C857",
  "#334D37",
...
```{r colorgorical2-show, eval=T, echo=F}
x = c(
  "#002B00",
  "#D57381",
  "#77CE3F",
...
I like <span class="pack">brms</span> quite a bit and use it a lot. It served as the motivation for these coefficient plots, as did <span class="pack">bayesplot</span>, and <span class="pack">tidybayes</span>.
