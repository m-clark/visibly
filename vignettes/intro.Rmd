...
You have plenty of options for this sort of endeavor, such as corrplot, psych, and heatmaply.  However, they offer only static plots or reorder based on a cluster analysis.  I originally had [a function](https://github.com/m-clark/heatR) that would provide some interactivity, but while utilizing a factor analytic approach. I've now deprecated that standalone package and brought the functionality here. The corr_heat function provides an easy way to visualize your correlations.
