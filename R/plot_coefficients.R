...
#'
#' @param model The model that is the point of this function. For example, lm,
#'   glm, gam, lme4, brms.
...
#' @param sd_multi For `merMod` objects, the multiplier that determines the width of the interval.
#'   Default is 2.
